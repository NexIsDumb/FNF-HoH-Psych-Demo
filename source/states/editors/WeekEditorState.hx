...
class WeekEditorState extends MusicBeatState {
	...
	override function create() {
		...
		txtWeekTitle.setFormat(Constants.GENERIC_FONT, 32, FlxColor.WHITE, RIGHT);
		...
		missingFileText.setFormat(Constants.GENERIC_FONT, 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		txtTracklist.font = Constants.GENERIC_FONT;
