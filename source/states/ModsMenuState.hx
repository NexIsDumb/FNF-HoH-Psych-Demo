...
class ModsMenuState extends MusicBeatState {
	...
	override function create() {
		...
		if (FlxG.random.bool(0.1))
			noModsTxt.text += '\nUwU.'; // cute
		noModsTxt.setFormat(Constants.GENERIC_FONT, 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		buttonToggle.label.setFormat(Constants.GENERIC_FONT, 24, FlxColor.WHITE, CENTER);
		...
		buttonUp.label.setFormat(Constants.GENERIC_FONT, 24, FlxColor.BLACK, CENTER);
		...
		buttonDown.label.setFormat(Constants.GENERIC_FONT, 24, FlxColor.BLACK, CENTER);
		...
		buttonTop.label.setFormat(Constants.GENERIC_FONT, 24, FlxColor.BLACK, CENTER);
		...
		buttonDisableAll.label.setFormat(Constants.GENERIC_FONT, 24, FlxColor.BLACK, CENTER);
		...
		buttonEnableAll.label.setFormat(Constants.GENERIC_FONT, 24, FlxColor.BLACK, CENTER);
		...
		/*
			...
			installButton.label.setFormat(Constants.GENERIC_FONT, 16, FlxColor.WHITE, CENTER);
			...
			removeButton.label.setFormat(Constants.GENERIC_FONT, 16, FlxColor.WHITE, CENTER);
		...
		descriptionTxt.setFormat(Constants.GENERIC_FONT, 32, FlxColor.WHITE, LEFT);
