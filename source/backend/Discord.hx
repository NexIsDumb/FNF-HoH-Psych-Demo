...
class DiscordClient
{
	...
	private static var _defaultID:String = "1249046792658489484";
	...
	private static var _options:Dynamic = {
		...
		state: null,
		largeImageKey: 'icon',
		largeImageText: "Demo Build - Psych Engine",
		smallImageKey : null,
		startTimestamp : null,
		endTimestamp : null
	};
	...
	public static function changePresence(details:String, state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		_options.largeImageText = "Demo Build v" + Application.current.meta.get('version') + " - Psych Engine v" + states.MainMenuState.psychEngineVersion;
