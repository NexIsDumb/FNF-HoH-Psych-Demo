...
class NoteOffsetState extends MusicBeatState {
	...
	override public function create() {
		...
		timeTxt.setFormat(Constants.GENERIC_FONT, 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		changeModeText.setFormat(Constants.GENERIC_FONT, 32, FlxColor.WHITE, CENTER);
	...
	function createTexts() {
		for (i in 0...4) {
			...
			text.setFormat(Constants.GENERIC_FONT, 24, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
